...
const menuConfigData = {
  ...
  categories: [
    // 1. الشوربة (Soups)
    {
      ...
      items: [
        ...
        },
        {
          ...
          description_en: "Boiled chicken with fresh vegetables and Yemeni spices."
        },
        {
            name_en: "Shrimp Soup",
    ...
    // 2. السلطات والمقبلات (Appetizers & Salads)
    {
      ...
      items: [
        ...
        },
        {
            ...
            name_ar: "سلطة فتوش",
            price: 3500,
            description_ar: "رغيف عربي مقطع، زيت الزيتون، خس مقطع، طماطم، خيار، فلفل أخضر.",
    ...
    // 3. الطبق الرئيسي (Main Course)
    {
      id: "main_course_general",
      name_en: "Main Course",
      name_ar: "الطبق الرئيسي",
      mainImage: "images/main_course_general_collage.jpg", // Placeholder image
      items: [
        // هذا القسم فارغ حاليًا. يمكنك إضافة أطباق رئيسية عامة هنا لا تندرج تحت المشاوي أو الباستا أو الأسماك.
        // مثال: { name_en: "Chicken with White Sauce", name_ar: "دجاج بصوص أبيض", price: 10000, description_ar: "قطعة دجاج مطهوة بصوص كريمي.", description_en: "Chicken cooked in creamy white sauce." }
      ]
    },
    // 4. المشاوي (From the Grill)
    {
      ...
      items: [
        ...
        { name_en: "Broasted Chicken (Quarter)", name_ar: "دجاج بروست (ربع)", price: 5000,
          description_ar: "نصف دجاجة متبلة ومقلية بنكهة البهارات الخاصة. ويقدم مع البطاطس المقلية.", description_en: "Quarter chicken marinated and deep-fried with special spices. Served with French fries." },
        { name_en: "Broasted Chicken (Half)", name_ar: "دجاج بروست (نصف)", price: 10000,
          description_ar: "دجاجة كاملة متبلة ومقلية بنكهة البهارات الخاصة. وتقدم مع البطاطس المقلية.", description_en: "Half chicken marinated and deep-fried with special spices. Served with French fries." },
        ...
        { name_en: "Grilled Fish Fillet", name_ar: "سمك مشوي فيليه", price: 12000, description_ar: "سمك متبل مع الثوم، صلصة الليمون، زيت الزيتون، الخردل والكزبرة الطازجة. يقدم مع الأرز أو الشيبس. (السعر قد يختلف حسب النوع والحجم)", description_en: "Fish fillet marinated with garlic, lemon sauce, olive oil, mustard, and fresh coriander. Served with rice or chips. (Price may vary by type and size)" }
      ]
    },
    ...
    // 6. المطبخ اليمني (إفطار وعشاء) - Yemeni Cuisine (Breakfast & Dinner)
    {
      ...
      items: [
        ...
        { name_en: "Qulaba (Foul or Beans)", name_ar: "قلابة (فول أو فاصوليا)", price: 2500, description_ar: "فول أو فاصوليا مطبوخة، مطهية مع الخضار والتوابل اليمنية تقدم مع الخبز.", description_en: "Foul or beans cooked with vegetables and Yemeni spices. Served with bread." },
        ...
        { name_en: "Fasoolia (Beans) - Plain", name_ar: "فاصوليا عادي", price: 3500, description_ar: "فاصوليا مطبوخة سادة.", description_en: "Plain cooked beans." },
        { name_en: "Fasoolia Nashif", name_ar: "فاصوليا ناشف", price: 4000, description_ar: "فاصوليا مطبوخة بالطريقة الناشفة.", description_en: "Dry-style cooked beans." },
        { name_en: "Fasoolia with Eggs", name_ar: "فاصوليا بالبيض", price: 4000, description_ar: "فاصوليا مطبوخة مع البيض.", description_en: "Cooked beans with eggs." },
        { name_en: "Fasoolia with Cheese", name_ar: "فاصوليا بالجبن", price: 4000, description_ar: "فاصوليا مطبوخة مع الجبن.", description_en: "Cooked beans with cheese." },
        { name_en: "Fasoolia with Tuna", name_ar: "فاصوليا بالتونة", price: 4000, description_ar: "فاصوليا مطبوخة مع التونة.", description_en: "Cooked beans with tuna." },
        { name_en: "Foul - Plain", name_ar: "فول عادي", price: 3500, description_ar: "فول سادة مطبوخ.", description_en: "Plain cooked fava beans." },
        { name_en: "Foul with Tahini", name_ar: "فول بالطحينية", price: 4000, description_ar: "فول مطبوخ مع الطحينية.", description_en: "Cooked fava beans with tahini." },
        { name_en: "Foul with Eggs", name_ar: "فول بالبيض", price: 4000, description_ar: "فول مطبوخ مع البيض.", description_en: "Cooked fava beans with eggs." },
        { name_en: "Foul with Tuna", name_ar: "فول بالتونة", price: 4000, description_ar: "فول مطبوخ مع التونة.", description_en: "Cooked fava beans with tuna." },
        { name_en: "Foul with Cheese", name_ar: "فول بالجبن", price: 4000, description_ar: "فول مطبوخ مع الجبن.", description_en: "Cooked fava beans with cheese." },
        ...
        { name_en: "Bazlia with Tuna", name_ar: "بازليا بالتونة", price: 3500, description_ar: "بازلاء مطبوخة مع التونة.", description_en: "Cooked peas with tuna." },
        ...
        { name_en: "Cooked Shakshouka", name_ar: "شكشوكة", price: 3500, description_ar: "شكشوكة مطبوخة", description_en: "Cooked shakshouka." },
        { name_en: "Shakshouka with Vegetables", name_ar: "شكشوكة بالخضار", price: 3500, description_ar: "شكشوكة مطبوخة مع الخضار.", description_en: "Shakshouka cooked with vegetables." },
        { name_en: "Shakshouka with Cheese", name_ar: "شكشوكة بالجبنة", price: 3500, description_ar: "شكشوكة مطبوخة مع الجبنة.", description_en: "Shakshouka cooked with cheese." },
        {name_en: "Sahawq Plain",name_ar: "سحاوق عادي",price: 1000,description_ar: "صلصة السحاوق اليمنية التقليدية الحارة.",description_en: "Traditional Yemeni hot sahawq sauce."},
        {name_en: "Sahawq with Cheese",name_ar: "سحاوق جبن",price: 3000,description_ar: "صلصة السحاوق اليمنية مع إضافة الجبن.",description_en: "Traditional Yemeni sahawq sauce with added cheese."},
        ...
        { name_en: "Samak Mutafaya (Fish Sauté)", name_ar: "سمك مطفاية", price: 13000,
          description_ar: "شرائح السمك مقلاة مع البصل المحمر، البسباس الحار، الطماط والكزبرة يقدم مع الأرز الشرقي.", description_en: "Fish slices sautéed with fried onions, hot chili, tomatoes, and coriander. Served with oriental rice." },
        ...
        { name_en: "Small Meat (Lahm Saghar)", name_ar: "لحم صغار", price: 7000, description_ar: "قطع لحم صغيرة مطهوة على الطريقة اليمنية.", description_en: "Small pieces of lamb cooked Yemeni style." },
        { name_en: "Raqat Lahm (Thin Meat)", name_ar: "دقة لحم", price: 6500, description_ar: "شرائح لحم رقيقة مطهوة.", description_en: "Thin slices of lamb cooked Yemeni style." },
          ]
    },
	// قسم المطبخ اليمني (العام) - Yemeni Cuisine (General)
    {
      ...
      items: [
        ...
        { name_en: "Kabsa (Cold)", name_ar: "كبسة بارد", price: "Ask Server", description_ar: "كبسة باردة (اسأل عن التفاصيل).", description_en: "Cold Kabsa (ask for details)." },
        { name_en: "Kabsa (Hot)", name_ar: "كبسة حار", price: "Ask Server", description_ar: "كبسة حارة (اسأل عن التفاصيل).", description_en: "Hot Kabsa (ask for details)." },
        {name_en: "Sahawq Plain",name_ar: "سحاوق عادي",price: 1000,description_ar: "صلصة السحاوق اليمنية التقليدية الحارة.",description_en: "Traditional Yemeni hot sahawq sauce."},
        {name_en: "Sahawq with Cheese",name_ar: "سحاوق جبن",price: 3000,description_ar: "صلصة السحاوق اليمنية مع إضافة الجبن.",description_en: "Traditional Yemeni sahawq sauce with added cheese."},
    ...
    // 7. الحلويات (Desserts)
    {
      ...
      items: [
        ...
        { name_en: "Cream Caramel", name_ar: "كريم كراميل", price: "Ask Server", description_ar: "حلى كريمي ناعم بالكراميل.", description_en: "Smooth creamy dessert with caramel." },
        { name_en: "Oriental Sweets", name_ar: "حلويات شرقية", price: "Ask Server", description_ar: "تشكيلة من الحلويات الشرقية التقليدية.", description_en: "Assortment of traditional oriental sweets." },
        { name_en: "Cake of the Day", name_ar: "كيك اليوم", price: "Ask Server", description_ar: "اسأل النادل عن كيك اليوم المميز.", description_en: "Please ask your server for today's special cake." }
      ]
    },
    // 8. العصائر الباردة (Cold Beverages)
    {
      ...
      items: [
        ...
        { name_en: "Mango Juice", name_ar: "عصير المانجو", price: 700, description_ar: "عصير مانجو طبيعي.", description_en: "Natural mango juice." },
    ...
    // 9. المشروبات الساخنة (Hot Beverages)
    {
      ...
      items: [
        ...
        { name_en: "Hot Chocolate", name_ar: "شوكولاتة ساخنة", price: "Ask Server", description_ar: "مشروب الشوكولاتة الساخنة الغني.", description_en: "Rich hot chocolate beverage." },
        { name_en: "Milk (Hot/Cold)", name_ar: "حليب بارد / ساخن", price: "Ask Server", description_ar: "حليب طازج بارد أو ساخن.", description_en: "Fresh milk, hot or cold." },
        { name_en: "Tea", name_ar: "شاي", price: 400, description_ar: "شاي أحمر أو أخضر كلاسيكي.", description_en: "Classic red or green tea." },
        { name_en: "Adani Tea", name_ar: "شاي عدني", price: 400, description_ar: "شاي عدني مبهر بالحليب والهيل والبهارات.", description_en: "Spiced Adani tea with milk, cardamom, and other spices." }
      ]
    },
      ...
      items: [
        {
          ...
          description_en: "A variety of cheese, olives, foul mudammas or beans, tomatoes and cucumber, and your choice of eggs (boiled or fried). Served with milk or tea."
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          name_ar: "برجر لحم",
          price: 5000,
          description_ar: "برجر لحم صافي مع صلصة المايونيز والمخللات والبصل السوتيه يقدم بخبز السمسم والبطاطس المقلية.",
          description_en: "Pure beef burger with mayonnaise sauce, pickles, and sautéed onions served with sesame bun and French fries."
        },
        {
          name_en: "Chicken Burger",
            name_ar: "برجر دجاج", // Changed to specify Chicken Burger
            price: 5000,
    ...
    // أطباق أسماك خاصة (غير موجودة في الترتيب المرقم)
    {
      ...
      items: [
        { name_en: "Grilled Derk Fish", name_ar: "سمك مشوي ديرك", price: "Ask Server", description_ar: "سمك ديرك مشوي. (السعر حسب الوزن/التفاصيل)", description_en: "Grilled Derk fish. (Price by weight/details)" },
        { name_en: "Derk Fish Tafaaya", name_ar: "سمك طفاية ديرك", price: "Ask Server", description_ar: "سمك ديرك مطبوخ بطريقة الطفاية. (السعر حسب الوزن/التفاصيل)", description_en: "Derk fish cooked Tafaaya style. (Price by weight/details)" },
        { name_en: "Grilled Kan'ad Fish", name_ar: "سمك مشوي كنعد", price: "Ask Server", description_ar: "سمك كنعد مشوي. (السعر حسب الوزن/التفاصيل)", description_en: "Grilled Kan'ad fish. (Price by weight/details)" },
        { name_en: "Kan'ad Fish Tafaaya", name_ar: "سمك طفاية كنعد", price: "Ask Server", description_ar: "سمك كنعد مطبوخ بطريقة الطفاية. (السعر حسب الوزن/التفاصيل)", description_en: "Kan'ad fish cooked Tafaaya style. (Price by weight/details)" },
        ...
        { name_en: "Thamd Broasted Fish", name_ar: "سمك برست ثمد", price: "Ask Server", description_ar: "سمك ثمد مقلي بروست. (السعر حسب الوزن/التفاصيل)", description_en: "Broasted fried Thamd fish. (Price by weight/details)" },
      ]
    },
  ]
};